...
const FINISH_BASE = 'btn btn-ghost btn-sm h-auto flex-col gap-0.5 px-1.5 py-1 shrink-0 border border-success text-success';
const FINISH_ACTIVE = 'btn btn-ghost btn-sm h-auto flex-col gap-0.5 px-1.5 py-1 shrink-0 border border-success text-success bg-success/15';
