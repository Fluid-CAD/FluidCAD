...
import iconGizmo from '@tabler/icons/outline/gizmo.svg?raw';
...
export const ICON_GIZMO = iconGizmo;
...
export const ICON_LOCK_OPEN = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="11" width="14" height="10" rx="2"/><circle cx="12" cy="16" r="1"/><path d="M8 11v-5a4 4 0 0 1 8 0"/></svg>';
