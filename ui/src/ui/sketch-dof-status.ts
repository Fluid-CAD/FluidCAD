...
export class SketchDofStatus {
  ...
  constructor(
    ...
    this.expandedList.className = 'absolute bottom-16 left-1/2 -translate-x-1/2 z-[100] panel-bg border border-base-content/10 rounded-md p-2 text-xs text-base-content/80 hidden min-w-[220px]';
