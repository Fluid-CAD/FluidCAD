...
2. The Helix dialog:
   - Source: **From axis** (click a world axis shown in the viewport, an `axis()` feature, or a straight edge) or **From face** (click a cylindrical or conical face — its axis, radius and height are read from the geometry).
