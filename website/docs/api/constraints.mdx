...
| Parameter | Type | Description |
|-----------|------|-------------|
| `a` | [ConstraintTarget](#constraint-targets) | A line, an ellipse, or the first point |
| `b` | [ConstraintTarget](#constraint-targets) | The second point (point form) *(optional)* |
...
| `l` | [ConstraintTarget](#constraint-targets) | The line whose midpoint p takes; with b given, the first of the two points |
| `b` | [ConstraintTarget](#constraint-targets) | The second point, for the point-pair form `midpoint(p, a, b)` *(optional)* |
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `a` | [ConstraintTarget](#constraint-targets) | The first point or entity |
| `b` | [ConstraintTarget](#constraint-targets) | The second point or entity (same kind as a) |
| `l` | [ConstraintTarget](#constraint-targets) | The mirror line — a sketched line or `xAxis()` / `yAxis()` |
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `c` | [ConstraintTarget](#constraint-targets) | The circle, arc or ellipse |
