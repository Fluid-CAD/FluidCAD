...
```ts
offset(distance: number, removeOriginal: boolean, targetPlane: PlaneLike | SceneObject, ...sourceGeometries: Extrudable[]): ExtrudableGeometry
```
...
| `targetPlane` | [PlaneLike](/docs/api/types/plane-like) \| [SceneObject](/docs/api/types/scene-object) | The plane to offset onto |
