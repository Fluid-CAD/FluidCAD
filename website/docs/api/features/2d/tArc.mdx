...
```ts
tArc(radius: number, endPoint: Point2DLike): Geometry
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `radius` | number | The arc radius. A negative value reverses the start direction. |
| `endPoint` | [Point2DLike](/docs/api/types/point2dlike) | The point the arc ends towards |
