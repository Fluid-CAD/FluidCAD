...
| Parameter | Type | Description |
|-----------|------|-------------|
| `...edgeFilters` | EdgeFilter[] | One or more edge filter builders. All must be satisfied. *(optional)* |
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `...edgeFilters` | EdgeFilter[] | One or more edge filter builders. If all are satisfied, the face is excluded. *(optional)* |
