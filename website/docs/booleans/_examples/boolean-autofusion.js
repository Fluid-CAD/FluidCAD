...
// A 60 × 60 square, drawn as four lines pinned by constraints.
sketch("xy", () => {
...
// A cylinder standing on the box: it touches the top face, so it fuses into
// the same solid — no boolean statement needed.
extrude(50)
