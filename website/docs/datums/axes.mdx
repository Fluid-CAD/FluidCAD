...
2. Click a **straight edge** in the viewport, or one of the **world axes** the viewport shows while the slot is armed (X red, Y green, Z blue). Existing `axis()` features can be clicked too, in the viewport or the timeline.
