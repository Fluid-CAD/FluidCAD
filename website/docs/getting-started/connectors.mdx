...
![The fixed leaf with its connectors](/img/docs/getting-started/hinge-leaf-fixed.png)
...
![The swing leaf](/img/docs/getting-started/hinge-leaf-swing.png)
...
![The pin](/img/docs/getting-started/hinge-pin.png)
