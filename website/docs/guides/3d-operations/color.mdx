...
Passing a scene object instead of a face selection colors every face of that object's solids:

```js
const body = extrude(30)
color("steelblue", body)       // color the entire body
```

This is the quickest way to give a part a base color, which you can then override face by face:

```js
const body = extrude(30)
color("steelblue", body)       // base color for every face
