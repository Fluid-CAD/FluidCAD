...
<CodeBlock language="js">{extrudeThin}</CodeBlock>
...
<CodeBlock language="js">{extrudeThinDual}</CodeBlock>
...
<CodeBlock language="js">{extrudeThinOpen}</CodeBlock>
...
<CodeBlock language="js">{extrudeThinOpenDual}</CodeBlock>
