...
Inside a sketch, holes don't need a boolean at all: a closed profile drawn inside another becomes a hole in the outer region automatically when you extrude.
