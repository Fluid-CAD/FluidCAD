...
The cut that follows only hides the hole sketch, so it is still there to publish. The gasket never redraws the bolt circle: it cuts the flange's own pattern, so moving a bolt hole on the flange moves it on the gasket.
