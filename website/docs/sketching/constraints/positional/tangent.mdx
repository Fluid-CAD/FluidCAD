...
1. Click a line and an arc / circle / ellipse, or two arcs / circles / ellipses.
...
<UiFigure
  src="/img/docs/ui/constraint-bar-tangent.png"
  alt="The constraint bar with a line and an arc picked and the Tangent button highlighted"
  rings={[{x: 33.0, y: 11.6, w: 6.9, h: 44.2}]}
  caption="A line and an arc picked: Tangent is enabled."
/>

<ModeTable columns={[
  {title: 'Before', image: '/img/docs/sketching/constraint-tangent-junction-before.png', description: 'The arc is joined to the line by coincident, but meets it at a corner.'},
  {title: 'After', code: 'tangent(l, a)', image: '/img/docs/sketching/constraint-tangent-junction.png', description: 'The arc leaves the line without a kink.'},
]} />
