...
Called inside `sketch(...)`, `mirror()` reflects sketch geometry across a sketched line or an axis: `mirror(l, g1, g2)`, `mirror(yAxis())`. See [Mirror](/docs/sketching/tools/mirror) in the sketch tools.
