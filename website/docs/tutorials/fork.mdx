...
`arc(18)` draws a semicircular arc of radius 18 from the origin — this is the inner edge of the arch. `offset(18).close()` adds a parallel arc 18 units away and closes both ends, giving the arch a wall thickness of 18.
