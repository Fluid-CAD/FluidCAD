...
- **Tangent edges** — where two faces meet smoothly, as at a fillet's boundary or where a flat flank runs into a cylinder — are drawn dimmed, pulled toward the face colour. They remain selectable.
