...
export const features: FeatureEntry[] = [
  ...
  { name: 'hMove', displayName: 'hMove', category: '2d', sourceFile: 'core/2d/hmove.ts', interfaceName: 'HMoveFunction', returnType: 'void', sidebarPosition: 14 },
  { name: 'vMove', displayName: 'vMove', category: '2d', sourceFile: 'core/2d/vmove.ts', interfaceName: 'VMoveFunction', returnType: 'void', sidebarPosition: 15 },
  { name: 'rMove', displayName: 'rMove', category: '2d', sourceFile: 'core/2d/rmove.ts', interfaceName: 'RMoveFunction', returnType: 'IGeometry', sidebarPosition: 16 },
  { name: 'pMove', displayName: 'pMove', category: '2d', sourceFile: 'core/2d/pmove.ts', interfaceName: 'PolarMoveFunction', returnType: 'IGeometry', sidebarPosition: 17 },
  // 2D Sketching — Constrained Geometry
  { name: 'tLine', displayName: 'tLine', category: '2d', sourceFile: 'core/2d/tline.ts', interfaceName: 'TLineFunction', returnType: 'IGeometry', relatedGuide: '/docs/guides/sketching/constrained-geometry', sidebarPosition: 18 },
  { name: 'tCircle', displayName: 'tCircle', category: '2d', sourceFile: 'core/2d/tcircle.ts', interfaceName: 'TCircleFunction', returnType: 'IGeometry', relatedGuide: '/docs/guides/sketching/constrained-geometry', sidebarPosition: 19 },
  { name: 'tArc', displayName: 'tArc', category: '2d', sourceFile: 'core/2d/tarc.ts', interfaceName: 'TArcFunction', returnType: 'IGeometry', relatedGuide: '/docs/guides/sketching/constrained-geometry', sidebarPosition: 20 },
  { name: 'connect', displayName: 'connect', category: '2d', sourceFile: 'core/2d/connect.ts', interfaceName: 'ConnectFunction', returnType: 'IGeometry', sidebarPosition: 21 },
  // 2D Sketching — Advanced Operations
  { name: 'offset', displayName: 'offset', category: '2d', sourceFile: 'core/2d/offset.ts', interfaceName: 'OffsetFunction', returnType: 'IOffset', relatedGuide: '/docs/guides/sketching/offset', sidebarPosition: 22 },
