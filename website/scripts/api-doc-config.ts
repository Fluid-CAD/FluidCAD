...
export const types: TypeEntry[] = [
  ...
  { name: 'IFuseable', displayName: 'Fuseable', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 3 },
  { name: 'IGeometry', displayName: 'Geometry', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 4 },
  ...
  { name: 'IExtrude', displayName: 'Extrude', sourceFile: 'core/interfaces.ts', extendsType: 'IFuseable', sidebarPosition: 6 },
  { name: 'ICut', displayName: 'Cut', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 7 },
  { name: 'IRevolve', displayName: 'Revolve', sourceFile: 'core/interfaces.ts', extendsType: 'IFuseable', sidebarPosition: 8 },
  { name: 'ILoft', displayName: 'Loft', sourceFile: 'core/interfaces.ts', extendsType: 'IFuseable', sidebarPosition: 9 },
  { name: 'ISweep', displayName: 'Sweep', sourceFile: 'core/interfaces.ts', extendsType: 'IFuseable', sidebarPosition: 10 },
  { name: 'ICommon', displayName: 'Common', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 11 },
  { name: 'IShell', displayName: 'Shell', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 12 },
  { name: 'IDraft', displayName: 'Draft', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 29 },
  ...
  { name: 'IPlane', displayName: 'Plane', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 18 },
  { name: 'IAxis', displayName: 'Axis', sourceFile: 'core/interfaces.ts', extendsType: 'ITransformable', sidebarPosition: 19 },
