...
export const features: FeatureEntry[] = [
  ...
  { name: 'text', displayName: 'text', category: '2d', sourceFile: 'core/2d/text.ts', interfaceName: 'TextFunction', returnType: 'IText', relatedGuide: '/docs/guides/sketching/primitive-shapes', sidebarPosition: 9 },
